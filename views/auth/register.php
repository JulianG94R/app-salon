...
<form action="/register" class="formulario" method="POST">
    ...
    <div class="campo">
        ...
        <input type="tel" name="telefono" id="telefono" placeholder="Ingrese su Teléfono" value="<?php echo s($usuario->telefono); ?>" ?>>
    </div>

    <div class="campo">
        <label for="email">Email:</label>
        <input type="email" name="email" id="email" placeholder="Ingrese su E-mail" value="<?php echo s($usuario->email); ?>">
    </div>
